...
def main():
    ...
    # まだ可能な組み合わせが残っている場合`
        ...
        # venti を作る！
        (venti1, current_student_groups, past_venti_list) = create_venti(current_student_groups, past_venti_list)
        print("Venti1:")
        print(venti1)
        print()
        (venti2, current_student_groups, past_venti_list) = create_venti(current_student_groups, past_venti_list)
        print("Venti2:")
        print(venti2)
        print()
